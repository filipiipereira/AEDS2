...
void selecaorecursiva2(Pokemon array[], int i, int tamanho) {
    if (i < tamanho - 1) {
        int menor = i;
        ...
        selecaorecursiva2(array, i + 1, tamanho);
    }
}

void selecaoRecursiva(Pokemon array[], int n) {
    selecaorecursiva2(array, 0, n);
}
...
int main() {
    ...
    selecaoRecursiva(pokemonsSelecionados, quantidadePokemonsSelecionados);
    for(int i = 0; i < quantidadePokemonsSelecionados; i++){
